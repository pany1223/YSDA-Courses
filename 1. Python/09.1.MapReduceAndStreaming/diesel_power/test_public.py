...
def test_reducer(case: ReduceCase) -> None:
    ...
    # print(sorted(reducer_result, key=key_func))
    # print(sorted(reducer_etalon_rows, key=key_func))
    ...
    # print(sorted(result, key=key_func))
    # print(sorted(case.etalon, key=key_func))
    assert isinstance(result, tp.Iterator)
    assert sorted(case.etalon, key=key_func) == sorted(result, key=key_func)
